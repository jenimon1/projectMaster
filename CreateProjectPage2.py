...
import projectMaster.myProjectHeaderPage
...
#########
    def publishButClicked(self):
        ...
        self.mainWindow.setStyleSheet("LogInMainWindow {background-image: url(projectMaster/Images/MenuBack.jpg)}")
    ...
    def cancelButClicked(self):
        ...
        #     "LogInMainWindow {background-image: url(projectMaster/Images/MenuBack.jpg)}")
        if (self.getParentWidget() == "CreateOrViewProjectPage"):
            ...
            myProjHeaderWindow = projectMaster.myProjectHeaderPage.MyProjectHeaderPageMainWindow(self.mainWindow)
            self.mainWindow.setCentralWidget(myProjHeaderWindow)
